...
import { dmcColumns, dmcDataSource } from '../../util/dmc/default'
...
class DMCQA extends Component {

    render = () => {
        return (
            <MyRow>
                <MyCol isPhoneFull={true} span={6}><MyTable columns={dmcColumns} dataSource={dmcDataSource}/> </MyCol>
                <MyCol isPhoneFull={true} span={6}><MyCollapse QAList={QAList}/></MyCol>
                <MyCol isPhoneFull={true} span={6}><MyCollapse QAList={QAList}/></MyCol>
            </MyRow>
        )
    }
