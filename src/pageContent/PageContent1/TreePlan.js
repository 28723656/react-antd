              ...
              {beforeStr}
                ...
                if (item.children) {
                    return (
                        ...
                        <TreeNode key={item.key} title={ <Tag color={item.color}>{item.percent>=100? <Text delete>{item.title}</Text>:item.title}</Tag>}>
                            {loop(item.children)}
                        </TreeNode>
                    );
                }
                return <TreeNode key={item.key} title={<Tag color={item.color}>{item.percent>=100? <Text delete>{item.title}</Text>:item.title}</Tag>} />;
            });
